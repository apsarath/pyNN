...
class DeepCorrNet2(object):
    ...
    def init(self, numpy_rng, theano_rng=None, l_rate=0.01, optimization="sgd", tied=False, n_visible_left=None, n_visible_right=None, n_hidden=None, n_hidden2=None, n_hidden3=None, lamda=5, W_left=None, W_right=None, b_left=None, b_right=None, W_left_prime=None, W_right_prime=None, b_prime_left=None, b_prime_right=None, W_left2=None, W_right2=None, b_left2=None, b_right2=None, W_left_prime2=None, W_right_prime2=None, b_prime_left2=None, b_prime_right2=None, W_left3=None, W_right3=None, b3=None, W_left_prime3=None, W_right_prime3=None, b_prime_left3=None, b_prime_right3=None, input_left=None, input_right=None, hidden_activation="sigmoid", output_activation="sigmoid", loss_fn = "squarrederror", op_folder=None):
        ...
        self.b_prime_right3 = self.Initializer.zero_vector("b_prime_right3", b_prime_right3, n_hidden2)
    ...
    def train_common(self,mtype="1111"):
        ...
        yy1_pre = T.dot(y1, self.W_left2) + self.b_left2
        yy1 = activation(yy1_pre, self.hidden_activation)
        yy12_pre = T.dot(yy1, self.W_left3) + self.b3
        yy12 = activation(yy12_pre, self.hidden_activation)
        z10_left_pre = T.dot(yy12, self.W_left_prime3) + self.b_prime_left3
        z10_right_pre = T.dot(yy12,self.W_right_prime3) + self.b_prime_right3
        z10_left = activation(z10_left_pre, self.output_activation)
        z10_right = activation(z10_right_pre, self.output_activation)
        z1_left_pre = T.dot(z10_left, self.W_left_prime2) + self.b_prime_left2
        z1_right_pre = T.dot(z10_right,self.W_right_prime2) + self.b_prime_right2
        ...
        yy2_pre = T.dot(y2, self.W_right2) + self.b_right2
        yy2 = activation(yy2_pre, self.hidden_activation)
        yy22_pre = T.dot(yy2, self.W_right3) + self.b3
        yy22 = activation(yy22_pre, self.hidden_activation)
        z20_left_pre = T.dot(yy22, self.W_left_prime3) + self.b_prime_left3
        z20_right_pre = T.dot(yy22,self.W_right_prime3) + self.b_prime_right3
        z20_left = activation(z20_left_pre, self.output_activation)
        z20_right = activation(z20_right_pre, self.output_activation)
        z2_left_pre = T.dot(z20_left, self.W_left_prime2) + self.b_prime_left2
        z2_right_pre = T.dot(z20_right,self.W_right_prime2) + self.b_prime_right2
        ...
        yy3left_pre = T.dot(y3left, self.W_left2) + self.b_left2
        yy3right_pre = T.dot(y3right, self.W_right2) + self.b_right2
        yy3left = activation(yy3left_pre, self.hidden_activation)
        yy3right = activation(yy3right_pre, self.hidden_activation)
        y3_pre = T.dot(yy3left, self.W_left3) + T.dot(yy3right, self.W_right3) + self.b3
        y3 = activation(y3_pre, self.hidden_activation)

        z30_left_pre = T.dot(y3, self.W_left_prime3) + self.b_prime_left3
        z30_right_pre = T.dot(y3,self.W_right_prime3) + self.b_prime_right3
        z30_left = activation(z30_left_pre, self.output_activation)
        z30_right = activation(z30_right_pre, self.output_activation)
        z3_left_pre = T.dot(z30_left, self.W_left_prime2) + self.b_prime_left2
        z3_right_pre = T.dot(z30_right,self.W_right_prime2) + self.b_prime_right2
        ...
        y1_mean = T.mean(yy12, axis=0)
        y1_centered = yy12 - y1_mean
        y2_mean = T.mean(yy22, axis=0)
        y2_centered = yy22 - y2_mean
    ...
    def save_params(self):
        ...
        params["n_hidden3"] = self.n_hidden3
    ...
    def load(self, folder, input_left=None, input_right=None):
        ...
        self.init(plist["numpy_rng"], theano_rng=plist["theano_rng"], l_rate=plist["l_rate"], optimization=plist["optimization"],
                  tied=plist["tied"], n_visible_left=plist["n_visible_left"], n_visible_right=plist["n_visible_right"], n_hidden=plist["n_hidden"], n_hidden2=plist["n_hidden2"], n_hidden3=plist["n_hidden3"],
                  ...
                  W_left2=folder+"W_left2", W_right2=folder+"W_right2", b_left2=folder+"b_left2", b_right2=folder+"b_right2",  W_left_prime2=folder+"W_left_prime2",
                  W_right_prime2=folder+"W_right_prime2", b_prime_left2=folder+"b_prime_left2", b_prime_right2=folder+"b_prime_right2",
                  W_left3=folder+"W_left3", W_right3=folder+"W_right3", b3=folder+"b3",  W_left_prime3=folder+"W_left_prime3",
                  W_right_prime3=folder+"W_right_prime3", b_prime_left3=folder+"b_prime_left3", b_prime_right3=folder+"b_prime_right3",
...
def trainCorrNet(src_folder, sct_folder, tgt_folder, batch_size = 20, training_epochs=40, use_valid=False, l_rate=0.01, optimization="sgd", tied=False, n_visible_left=None, n_visible_right=None, n_hidden=None, n_hidden2=None, n_hidden3=None, lamda=5, W_left=None, W_right=None, b_left=None, b_right=None, W_left_prime=None, W_right_prime=None, b_prime_left=None, b_prime_right=None, W_left2=None, W_right2=None, b_left2=None, b_right2=None, W_left_prime2=None, W_right_prime2=None, b_prime_left2=None, b_prime_right2=None,  W_left3=None, W_right3=None, b3=None, W_left_prime3=None, W_right_prime3=None, b_prime_left3=None, b_prime_right3=None, hidden_activation="sigmoid", output_activation="sigmoid", loss_fn = "squarrederror"):
