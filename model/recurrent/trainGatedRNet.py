...
from GatedRNet import *

def trainGatedRNet(src_folder, sct_folder, tgt_folder, batch_size = 20, wsize=1, esize=10, ne=10, n_hidden=5, n_out=10, embedding=None,  W_z=None, U_z=None, W_r=None, U_r=None, W=None, U=None,  W_out=None, bhid=None, b_z=None, b_r=None, h0=None, bout=None,  learning_rate = 0.1, training_epochs = 40, hidden_activation = "sigmoid", output_activation = "softmax",loss = "crossentrophy",use_valid=False, optimization = "sgd", bptt=10):
	...
	recnet = GatedRNet( numpy_rng = rng, l_rate=learning_rate, theano_rng=theano_rng, wsize=wsize, esize=esize, ne=ne, n_hidden=n_hidden, n_out=n_out, embedding=embedding,  W_z=W_z, U_z=U_z, W_r=W_r, U_r=U_r, W=W, U=U,  W_out=W_out, bhid=bhid, b_z=b_z, b_r=b_r, h0=h0, bout=bout, hidden_activation = hidden_activation, output_activation = output_activation, loss = loss,optimization = optimization)
